                  ...
                  children: <Widget>[
                    Center(
                      child: FadeInUp(
                        ...
                        child: Image.asset(
                          'assets/images/emergyai.png', // Reemplaza 'your_logo.png' con el nombre de tu archivo de logo
                          height: 100, // Ajusta el tamaño del logo según tu preferencia
                        ),
                      ),
                    ),
                    const SizedBox(
                      ...
                      FadeInUp(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            boxShadow: const [
                              BoxShadow(
                                color: Color.fromRGBO(108, 0, 0, 0.294),
                                blurRadius: 20,
                                offset: Offset(0, 10),
                              )
                            ],
